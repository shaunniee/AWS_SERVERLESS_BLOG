...
module "admin_api" {
  ...
  integrations = {
    ...
    get_posts = {
      ...
      type                    = "AWS_PROXY"
      uri                     = "${module.admin_blog_posts_lambda.lambda_alias_invoke_arns["live"]}"
    }
    ...
    get_upload_url = {
      ...
      integration_http_method = "POST"
      type                    = "AWS_PROXY"
      uri                     = module.presign_lambda.lambda_alias_invoke_arns["live"]
    }
    ...
    get_leads = {
      ...
      integration_http_method = "POST"
      type                    = "AWS_PROXY"
      uri                     = "${module.leads_lambda.lambda_alias_invoke_arns["live"]}"
    }
...
module "public_api" {
  ...
  integrations = {
    ...
    get_posts = {
      ...
      integration_http_method = "POST"
      type                    = "AWS_PROXY"
      uri                     = "${module.public_posts_lambda.lambda_alias_invoke_arns["live"]}"
    }
